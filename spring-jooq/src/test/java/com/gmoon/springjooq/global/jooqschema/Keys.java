...
public class Keys {
	...
	public static final UniqueKey<TbAccessLogRecord> CONSTRAINT_5 = Internal.createUniqueKey(TbAccessLog.TB_ACCESS_LOG,
		 DSL.name("CONSTRAINT_5"), new TableField[] {TbAccessLog.TB_ACCESS_LOG.ID}, true);
}
