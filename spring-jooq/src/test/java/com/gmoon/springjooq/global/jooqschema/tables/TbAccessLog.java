...
public class TbAccessLog extends TableImpl<TbAccessLogRecord> {
     ...
     */
    public final TableField<TbAccessLogRecord, TbAccessLogOs> OS = createField(DSL.name("os"), SQLDataType.VARCHAR(7).defaultValue(DSL.inline("NULL", SQLDataType.VARCHAR)).asEnumDataType(TbAccessLogOs.class), this, "");
