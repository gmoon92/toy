...
Claude Code에서 `.local`은 Git으로 공유하지 않는 개인 설정을 의미합니다.
...
- [Claude Code 공식 문서 - Settings](https://code.claude.com/docs/en/settings)
- [Claude Code 공식 문서 - Environment variables](https://code.claude.com/docs/en/env-vars)
- [Claude Code 공식 문서 - Available Settings](https://code.claude.com/docs/en/settings#available-settings)
