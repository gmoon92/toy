...
**문제는 AI의 아첨 현상(Sycophancy)**입니다. Sycophancy란 AI가 사용자의 입장에 맞춰 동의하려는 성향을 말합니다. 이로 인해 비판적 검증이 부족하고, **Hallucination(환각)** - 즉, 존재하지 않는 정볘이나 잘못된 내용을 사실처럼 생성하는 현상 - 으로 인해 잘못된 정보를 생성하기도 합니다.
