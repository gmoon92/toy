...
Anthropic 모델 가용성은 지역에 따라 다릅니다. 최신 정보는 [Vertex AI Model Garden](https://cloud.google.com/model-garden)에서 "Claude"를 검색하거나 [Claude 3 사용하기](https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/use-claude)를 참조하세요.
...
Vertex는 사용과 관련된 프롬프트 및 완성을 로깅할 수 있는 [요청-응답 로깅 서비스](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/request-response-logging)를 제공합니다.
