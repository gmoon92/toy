...
| [MCP 커넥터](./06-mcp-in-api-01-mcp-connector.md)               | 별도의 MCP 클라이언트 없이 Messages API에서 직접 원격 [MCP](/docs/en/mcp) 서버에 연결합니다.                              | <PlatformAvailability claudeApiBeta azureAiBeta />                          |
