...
- Claude Sonnet 3.7 ([지원 중단됨](/docs/en/about-claude/model-deprecations)) (`claude-3-7-sonnet-20250219`)
- Claude Haiku 4.5 (`claude-haiku-4-5-20251001`)
- Claude Haiku 3.5 ([지원 중단됨](/docs/en/about-claude/model-deprecations)) (`claude-3-5-haiku-latest`)
