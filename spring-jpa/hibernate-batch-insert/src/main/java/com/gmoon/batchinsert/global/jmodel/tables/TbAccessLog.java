...
public class TbAccessLog extends TableImpl<TbAccessLogRecord> {
     ...
     */
    public final TableField<TbAccessLogRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>batchinsert.tb_access_log.ip</code>.
     */
    public final TableField<TbAccessLogRecord, String> IP = createField(DSL.name("ip"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>batchinsert.tb_access_log.os</code>.
     */
    public final TableField<TbAccessLogRecord, String> OS = createField(DSL.name("os"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>batchinsert.tb_access_log.attempt_at</code>.
     */
    public final TableField<TbAccessLogRecord, LocalDateTime> ATTEMPT_AT = createField(DSL.name("attempt_at"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
