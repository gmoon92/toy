...
public class ExAccessLog extends TableImpl<ExAccessLogRecord> {
	 ...
	 */
	public final TableField<ExAccessLogRecord, String> ID = createField(DSL.name("id"),
		 SQLDataType.VARCHAR(50).nullable(false), this, "");

	/**
	 * The column <code>batchinsert.ex_access_log.username</code>.
	 */
	public final TableField<ExAccessLogRecord, String> USERNAME = createField(DSL.name("username"),
		 SQLDataType.VARCHAR(50).nullable(false), this, "");

	/**
	 * The column <code>batchinsert.ex_access_log.ip</code>.
	 */
	public final TableField<ExAccessLogRecord, String> IP = createField(DSL.name("ip"),
		 SQLDataType.VARCHAR(100).nullable(false), this, "");

	/**
	 * The column <code>batchinsert.ex_access_log.os</code>.
	 */
	public final TableField<ExAccessLogRecord, String> OS = createField(DSL.name("os"),
		 SQLDataType.VARCHAR(30).nullable(false), this, "");

	/**
	 * The column <code>batchinsert.ex_access_log.attempt_dt</code>.
	 */
	public final TableField<ExAccessLogRecord, String> ATTEMPT_DT = createField(DSL.name("attempt_dt"),
		 SQLDataType.VARCHAR(50).nullable(false), this, "");
