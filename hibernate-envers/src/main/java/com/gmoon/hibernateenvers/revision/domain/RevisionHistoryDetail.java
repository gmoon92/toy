...
public class RevisionHistoryDetail extends BaseEntity {
  ...
  private RevisionHistoryDetail(RevisionHistory revision, RevisionType revisionType, Serializable entityId, RevisionTarget revisionTarget, RevisionEventStatus revisionEventStatus) {
  ...
  public static RevisionHistoryDetail newCreate(RevisionHistory revision, RevisionType revisionType, Serializable entityId, RevisionTarget revisionTarget) {
