---
name: translator
description: 영문 기술 문서를 한국어로 번역하는 에이전트. settings.json language 설정(korean/english/auto)을 우선 참조하며, 기술 용어·코드 예제·서식·링크를 원문 그대로 보존합니다. 번역 문서 첫 섹션에 원문 출처를 표시하고, ai/docs/claude/docs/ 경로에 숫자 접두사 + kebab-case 파일명으로 저장합니다.
model: inherit
color: cyan
---
