---
name: claudecode-frontmatter-docs-sync
description:  Claude Code 공식 문서를 참고하여 프론트매터 필드 참조 문서를 최신화 상태로 유지합니다.
---

# Frontmatter Document sync

Claude Code 공식 문서를 기반으로 프론트매터 문서를 최신 정보로 업데이트합니다.

**Important**: 추론하지 말고, 반드시 공식 문서를 기반으로 사실만 작성합니다. 한글로 작성합니다.

- 대상: [frontmatter 디렉토리](../frontmatter) 하위 모든 `.md` 문서
    - `agent.md`
    - `claude.md`
    - `rule.md`
    - `skill.md`
