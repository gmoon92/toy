  ...
  "questions": [
    {
      ...
      "options": [
        ...
        {
          "label": "[65] 사용자 조회 메서드 추가",
          "description": "UserRepository에 인증용 조회 기능"
        },
        {
          "label": "[60] 설정 파일 업데이트",
        ...
        {
          "label": "[50] 예외 처리 핸들러 추가",
          "description": "JWT 관련 예외 처리 및 에러 응답"
        },
        {
          "label": "[이전 페이지]",
          "description": "(1-5번 항목으로)"
        },
        {
          "label": "바디 없음 (헤더만 사용)",
...
**Pagination flow:**
```
Page 1 (1-5) → [다음] → Page 2 (6-10) → [선택 완료]
                 ↑                      ↑
              [이전] ←───────────── [이전]
```
...
- Show 5 items per page (reduced pagination, less cognitive load)
...
User selects: 1번, 2번, 3번, [다음 페이지]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📝 Step 2/3: 바디 항목 선택 [페이지 2/2]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
→ Proceed to Stage 3 with 3 selected items
```
