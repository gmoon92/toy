...
- [Google Drive API Samples](https://developers.google.com/drive/api/v3/about-sdk)
- [Google Drive API mime](https://developers.google.com/drive/api/v3/ref-export-formats)
- [엑셀 to 구글 스프레드 시트 변환](https://google-master.tistory.com/7)
