...
import com.gmoon.commons.commonsapachepoi.excel.sax.handler.SaxXlsxSheetHandler;
...
public final class ExcelUtil {
	...
	private static String getStringCellValue(XSSFRow row, Integer cellColIdx) {
		if (row == null) {
			return null;
		}
