...
public class NegativeNumbersProvider implements ArgumentsProvider, AnnotationConsumer<NegativeNumbers> {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
		...
		Preconditions.condition(isNegativeNumbers(startInclusive), String.format("The starting(%d) value must be negative.", startInclusive));
		Preconditions.condition(isNegativeNumbers(endInclusive), String.format("The end(%d) value must be negative.", endInclusive));
